...
const Footer = () => {
  return (
    <footer id="contact" className="bg-[#CEAB2B] lg:grid lg:grid-cols-5">
      <div className="relative block h-32 lg:col-span-2 lg:h-full">
        <img
          src="https://i.pinimg.com/564x/55/39/8b/55398b80d2b3d3e43327a1626013d14e.jpg"
          alt=""
      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <ul className="mt-8 space-y-1 text-sm text-black">
              <li>193/ D 32 Kerawalapitiya Road</li>
              <li>Hendala, Wattala</li>
              <li>Sri Lanka</li>
            </ul>
